...
Summary: Descriptive analysis of death registration rates in India, disaggregated by age, sex, and wealth quintile. 
...
Create srvyr object with weights and cluster IDs for SEs 
...
```{r}
plot_left <- cowplot::plot_grid(urban_plot, age_plot, labels = "AUTO", cols = 1) 

full_plot <- cowplot::plot_grid(plot_left, state_plot, labels = c("", "C"), cols = 2, rel_widths = c(1.3, 1))
...
```{r}
# Facility distance quantile vs mean registration likelihood
...
# Road length quantile vs mean registration likelihood
